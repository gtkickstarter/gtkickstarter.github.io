...
var scControllerStyle = '<div class="crowdfund-controller-style">' +
'<div class="crowdfund-controller-tongue"><i class="fa fa-pencil"></i></div>' +
'<h5 class="crowdfund-controller-title">Select style</h5>' +
'<div class="crowdfund-underline crowdfund-underline-small crowdfund-underline-left"></div>' +
'<div class="crowdfund-controller-container"><a data-style="light" href="#" title="Light" class="crowdfund-controller-set-style crowdfund-circle-color bg-color-white"></a><a data-style="color" href="#" title="Colored" class="crowdfund-controller-set-style crowdfund-circle-color crowdfund-block-color"></a><a data-style="dark" href="#" title="Dark" class="crowdfund-controller-set-style crowdfund-circle-color bg-color-gray-dark"></a><a data-style="transparent" href="#" title="Transparent" class="crowdfund-controller-set-style crowdfund-circle-color crowdfund-transparent"></a></div></div>';

$(".crowdfund-color-ctrl").each(function(){
  $(this).append(scControllerStyle);
});

$(".crowdfund-controller-set-style").on("click", function(){
  var setStyle = $(this).attr("data-style");
  $(this).closest(".crowdfund-section, .crowdfund-section-color, .crowdfund-section-light, .crowdfund-section-dark, .crowdfund-section-transparent").removeClass("crowdfund-section-color crowdfund-section-light crowdfund-section-dark crowdfund-section-transparent").addClass("crowdfund-section-" + setStyle);
